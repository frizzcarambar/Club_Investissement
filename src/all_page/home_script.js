...
connexion.click(function(){
  ...
  $('body').prepend("<form id=\"form_connexion\" action=\"index.php?action=verifyconnexion\" method=\"post\"><h1>Login</h1><input type=\"text\" id=\"Mail\" name=\"name\" placeholder=\"Mail\"><input type=\"password\" id=\"password\" name=\"password\" placeholder=\"Password\"><input type=\"submit\" value=\"Login\"/><a href=\"index.php\">Quit</a></form>");
